...
#include "tfsarray.h"        // For class template TFSArray
#include "tfsarray.h"        // Double-inclusion check, for testing only
...
TEST_CASE( "TFSArray member types" )
{
    SUBCASE( "Member type value_type" )
    {
        {
        TFSArray<int>::value_type x1;
        [[maybe_unused]] int & r(x1);
        INFO( "TFSArray<int>::value_type must be int" );
        REQUIRE( TypeCheck<int>::check(x1) );
        }

        {
        TFSArray<string>::value_type x2;
        [[maybe_unused]] string & r(x2);
        INFO( "TFSArray<string>::value_type must be string" );
    ...
    {
        {
        TFSArray<int>::size_type x1;
        [[maybe_unused]] size_t & r(x1);
        INFO( "TFSArray<int>::size_type must be size_t" );
        REQUIRE( TypeCheck<size_t>::check(x1) );
        }

        {
        TFSArray<string>::size_type x2;
        [[maybe_unused]] size_t & r(x2);
        INFO( "TFSArray<string>::size_type must be size_t" );
    ...
    {
        {
        TFSArray<int>::iterator x1;
        [[maybe_unused]] int * & r(x1);
        INFO( "TFSArray<int>::iterator must be (int *)" );
        REQUIRE( TypeCheck<int *>::check(x1) );
        }

        {
        TFSArray<string>::iterator x2;
        [[maybe_unused]] string * & r(x2);
        INFO( "TFSArray<string>::iterator must be (string *)" );
        REQUIRE( TypeCheck<string *>::check(x2) );
        }
    }
    ...
    {
        {
        TFSArray<int>::const_iterator x1;
        [[maybe_unused]] const int * & r(x1);
        INFO( "TFSArray<int>::const_iterator must be (const int *)" );
        REQUIRE( TypeCheck<const int *>::check(x1) );
        }

        {
        TFSArray<string>::const_iterator x2;
        [[maybe_unused]] const string * & r(x2);
        INFO( "TFSArray<string>::const_iterator must be (const int *)" );
...
TEST_CASE( "TFSArray function return types" )
{
    SUBCASE( "Member function copy= - return type" )
    {
        {
        const TFSArray<int> cti;
        TFSArray<int> ti;
        [[maybe_unused]] TFSArray<int> & r(ti = cti);
        INFO( "TFSArray<int> copy= returns TFSArray<int> by ref" );
        REQUIRE( TypeCheck<TFSArray<int>>::check(ti = cti) );
        }

        {
        const TFSArray<string> cts;
        TFSArray<string> ts;
        [[maybe_unused]] TFSArray<string> & r(ts = cts);
        INFO( "TFSArray<string> copy= returns TFSArray<string> by ref" );
        REQUIRE( TypeCheck<TFSArray<string>>::check(ts = cts) );
        }
    }
    ...
    SUBCASE( "Member function move= - return type" )
    {
        ...
        TFSArray<int> ti2;
        TFSArray<int> ti3;
        [[maybe_unused]] TFSArray<int> & r(ti1 = move(ti2));
        INFO( "TFSArray<int> move= returns TFSArray<int> by ref" );
        REQUIRE( TypeCheck<TFSArray<int>>::check(ti2 = move(ti3)) );
        }
        ...
        TFSArray<string> ts2;
        TFSArray<string> ts3;
        [[maybe_unused]] TFSArray<string> & r(ts1 = move(ts2));
        INFO( "TFSArray<string> move= returns TFSArray<string> by ref" );
        REQUIRE( TypeCheck<TFSArray<string>>::check(ts2 = move(ts3)) );
        }
    }
    ...
    {
        {
        const TFSArray<int> cti(10);
        [[maybe_unused]] size_t && r(cti.size());
        INFO( "TFSArray<int> size returns size_t by value" );
        REQUIRE( TypeCheck<size_t>::check(cti.size()) );
        }

        {
        const TFSArray<string> cts(10);
        [[maybe_unused]] size_t && r(cts.size());
        INFO( "TFSArray<string> size returns size_t by value" );
    ...
    SUBCASE( "Member function empty - return type" )
    {
        ...
        INFO( "TFSArray<int> empty returns bool by value" );
        ...
        INFO( "TFSArray<string> empty returns bool by value" );
    ...
    SUBCASE( "Member function bracket op - return type" )
    {
        ...
        INFO( "TFSArray<int> bracket op returns int by ref" );
        REQUIRE( TypeCheck<int>::check(ti[0]) );
        }

        {
        TFSArray<string> ts(10);
        [[maybe_unused]] string & r(ts[0]);
        INFO( "TFSArray<string> bracket op returns string by ref" );
        ...
        INFO( "const TFSArray<int> bracket op returns const int by ref" );
        ...
        INFO( "const TFSArray<string> bracket op returns const string by ref" );
    ...
    SUBCASE( "Member function begin - return type" )
    {
        ...
        INFO( "TFSArray<int> begin returns (int *) by value" );
        ...
        INFO( "TFSArray<string> begin returns (string *) by value" );
        ...
        INFO( "const TFSArray<int> begin returns (const int *) by value" );
        ...
        INFO( "const TFSArray<string> begin returns (const string *) by value" );
    ...
    SUBCASE( "Member function end - return type" )
    {
        ...
        INFO( "TFSArray<int> end returns (int *) by value" );
        ...
        INFO( "TFSArray<string> end returns (string *) by value" );
        ...
        INFO( "const TFSArray<int> end returns (const int *) by value" );
        ...
        INFO( "const TFSArray<string> end returns (const string *) by value" );
    ...
    SUBCASE( "Member function insert - return type" )
    {
        ...
        INFO( "TFSArray<int> insert returns (int *) by value" );
        ...
        INFO( "TFSArray<string> insert returns (string *) by value" );
    ...
    SUBCASE( "Member function erase - return type" )
    {
        ...
        INFO( "TFSArray<int> erase returns (int *) by value" );
        ...
        INFO( "TFSArray<string> erase returns (string *) by value" );
...
TEST_CASE( "TFSArray noexcept" )
{
    TFSArray<Counter> tc1;
    TFSArray<Counter> tc2;

    SUBCASE( "noexcept - move ctor" )
    {
        INFO( "Move ctor must be noexcept" );
        REQUIRE( noexcept(TFSArray<Counter>(move(tc1))) );
    }
    ...
    SUBCASE( "NOT noexcept - copy ctor" )
    {
        ...
        REQUIRE_FALSE( noexcept(TFSArray<Counter>(tc1)) );
    }

    SUBCASE( "NOT noexcept - ctor from size" )
    {
        INFO( "Ctor from size must NOT be noexcept" );
        REQUIRE_FALSE( noexcept(TFSArray<Counter>(100)) );
    }
...
TEST_CASE( "TFSArray default ctor, size, empty" )
{
    SUBCASE( "Default ctor" )
    {
        const TFSArray<int> cti;
        {
        INFO( "Default constructed TFSArray has size 0" );
        REQUIRE( cti.size() == size_t(0) );
        }
        {
        INFO( "Default constructed TFSArray is empty" );
        REQUIRE( cti.empty() );
        }
        {
        INFO( "Default constructed TFSArray: begin == end" );
...
TEST_CASE( "TFSArray ctor from size, size, empty, begin, end" )
{
    SUBCASE( "Ctor from size - size 0" )
    {
        const size_t SIZE = size_t(0);
        const TFSArray<int> cti(SIZE);
        {
        INFO( "TFSArray constructed with size " << SIZE << ": size" );
        REQUIRE( cti.size() == SIZE );
        }
        {
        INFO( "TFSArray constructed with size " << SIZE << " is empty" );
        REQUIRE( cti.empty() );
        }
        {
        INFO( "TFSArray constructed with size " << SIZE << ": begin == end" );
        REQUIRE( cti.begin() == cti.end() );
        }
    }
    ...
    SUBCASE( "Ctor from size - small size" )
    {
        ...
        {
        INFO( "TFSArray constructed with size " << SIZE << " is not empty" );
        REQUIRE_FALSE( cti.empty() );
        }
        {
        INFO( "TFSArray constructed with size " << SIZE << ": begin" );
        REQUIRE( cti.begin() == &cti[0] );
        }
        {
        INFO( "TFSArray constructed with size " << SIZE << ": end" );
...
TEST_CASE( "TFSArray bracket operator" )
{
    SUBCASE( "Bracket op" )
    {
        const size_t SIZE = size_t(10);
        TFSArray<int> ti(SIZE);
...
TEST_CASE( "TFSArray copy assignment operator" )
{
...
TEST_CASE( "TFSArray move assignment operator" )
{
...
TEST_CASE( "TFSArray push_back & pop_back" )
{
...
TEST_CASE( "TFSArray swap" )
{
    SUBCASE( "swap" )
    {
        const size_t SIZE1 = size_t(10);
        const size_t SIZE2 = size_t(1000);
        TFSArray<int> ti1(SIZE1);
        for (size_t i = 0; i < SIZE1; ++i)
        {
            ti1[i] = int(i)*int(i);
        }
        TFSArray<int> ti2(SIZE2);
        for (size_t i = 0; i < SIZE2; ++i)
        {
            ti2[i] = 100-int(i);
        }
...
TEST_CASE( "TFSArray ctor/dctor count" )
{
    SUBCASE( "Ctor/dctor calls on construction by size, destruction" )
    {
        ...
        size_t objectcount;  // Ctor calls - dctor calls
        {
            ...
            const TFSArray<Counter> tc(SIZE);
    ...
    SUBCASE( "Ctor/dctor calls on move construction, destruction" )
    {
        ...
        {
            TFSArray<Counter> tc;
            const TFSArray<Counter> tc2(move(tc));
...
TEST_CASE( "TFSArray exceptions" )
{
    ...
    SUBCASE( "Exceptions - copy ctor" )
    {
        Counter::reset(true);
        {
            const TFSArray<Counter> tc(10);

            try
            {
                TFSArray<Counter> tc2(tc);
    ...
    SUBCASE( "Exceptions - move ctor" )
    {
        ...
        {
            TFSArray<Counter> tc(10);

            try
            {
                TFSArray<Counter> tc2(move(tc));
                throws = false;
            }
            catch (...)
            {
    ...
    SUBCASE( "Exceptions - swap" )
    {
        Counter::reset(true);
        {
            TFSArray<Counter> tc1(10);
            TFSArray<Counter> tc2(1000);
